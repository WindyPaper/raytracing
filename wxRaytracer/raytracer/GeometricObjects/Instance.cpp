...
void Instance::set_material(Material* materialPtr)
{
	material_ptr = materialPtr;
}

bool Instance::hit(const Ray& ray, double& t, ShadeRec *sr /*= 0*/) const
{
	Ray inv_ray(ray);
	inv_ray.o = inv_matrix * ray.o;
	inv_ray.d = inv_matrix * ray.d;
...
void Instance::set_bounding_box()
{
